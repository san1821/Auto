...
var _home = __webpack_require__(/*! ../apiFormat/home */ "./src/apiFormat/home.js");
...
var _apiManifest = __webpack_require__(/*! ../apiDetails/apiManifest */ "./src/apiDetails/apiManifest.js");

var _apiManifest2 = _interopRequireDefault(_apiManifest);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function runAll(dispatch, payload) {
  for (var i = 0; i < _apiManifest2.default.length; i++) {
    makeAPICall(_apiManifest2.default[i], dispatch);
  }
}

function runTest(dispatch, payload) {
  var selectedAPI = _underscore2.default.findWhere(_apiManifest2.default, { id: payload.id });
  if (selectedAPI) {
  ...
  for (var key in json) {
    ...
    switch (json[key].type) {
      ...
      case 'Array':
        ...
        break;
      case 'Object':
        typeMatched = _typeof(data[key]) === 'object' ? true : false;
        break;
      case 'Number':
    ...
    if (json[key].type === 'Array' && json[key].value && typeMatched) {
      result[key].value = [];
    ...
    if (json[key].type === 'Object' && json[key].value && typeMatched) {
      var _newPath = path.slice(0);
      _newPath.push(key);
      result[key].value = {};

      parseJSON(json[key].value, data[key], _newPath, result[key].value, errorResult);
    }
  }
}
...
var _reducerCreator = __webpack_require__(/*! ./reducerCreator */ "./src/js/reducerCreator.js");

var _reducers = __webpack_require__(/*! ./reducers */ "./src/js/reducers.js");

var _reducers2 = _interopRequireDefault(_reducers);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var reducerEnhancer = typeof window != 'undefined' && window.devToolsExtension ? window.devToolsExtension() : function (f) {
  return f;
};
var initialReducer = (0, _reducerCreator.reducerCreator)({}, _reducers2.default);

function onLoad() {
  var store = (0, _redux.createStore)(initialReducer, window._state, reducerEnhancer);
...
var _actions = __webpack_require__(/*! ./actions */ "./src/js/actions.js");
...
var APIStructureTester = function (_React$Component) {
  _inherits(APIStructureTester, _React$Component);

  function APIStructureTester() {
    _classCallCheck(this, APIStructureTester);

    var _this = _possibleConstructorReturn(this, (APIStructureTester.__proto__ || Object.getPrototypeOf(APIStructureTester)).call(this));

    _this.runAll = _this.runAll.bind(_this);
    return _this;
  }

  _createClass(APIStructureTester, [{
    key: 'runAll',
    value: function runAll() {
      (0, _actions.runAll)(this.props.dispatch);
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var data = _apiManifest2.default.map(function (apidata, i) {
        var response = self.testResponse && self.testResponse[apidata.id];
        return _react2.default.createElement(API, { apidata: apidata, dispatch: self.dispatch, response: response, key: i });
      });
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(APIStructureTester);

var API = function (_React$Component2) {
  _inherits(API, _React$Component2);

  function API(props) {
    _classCallCheck(this, API);

    var _this2 = _possibleConstructorReturn(this, (API.__proto__ || Object.getPrototypeOf(API)).call(this, props));

    _this2.runTest = _this2.runTest.bind(_this2);
  ...
  _createClass(API, [{
    ...
    value: function runTest() {
      (0, _actions.runTest)(this.props.dispatch, {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'column' },
          this.props.apidata.displayName
        ),
        _react2.default.createElement(
          'div',
          { className: 'column' },
          this.props.apidata.url
        ),
        _react2.default.createElement(
          'div',
          { className: 'column' },
        ...
        this.props.response && _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'tab-header ' + (this.state.tab === 'error' ? 'active' : ''), onClick: this.error },
              'Error'
            ),
            _react2.default.createElement(
              'div',
              { className: 'tab-header ' + (this.state.tab === 'all' ? 'active' : ''), onClick: this.all },
              'All'
            )
          ),
          _react2.default.createElement(
...
var ResultFormatter = function (_React$Component3) {
  _inherits(ResultFormatter, _React$Component3);

  function ResultFormatter() {
    _classCallCheck(this, ResultFormatter);

    return _possibleConstructorReturn(this, (ResultFormatter.__proto__ || Object.getPrototypeOf(ResultFormatter)).apply(this, arguments));
  }

  _createClass(ResultFormatter, [{
    key: 'render',
    value: function render() {
      var rows = [];
      for (var key in this.props.data) {
        var result = this.props.data[key];
        rows.push(_react2.default.createElement(
          'div',
          { className: 'result-row' },
          _react2.default.createElement(
            'div',
            { className: 'result-column fixed' },
            key
          ),
          _react2.default.createElement(
            'div',
            { className: 'result-column fixed ' + (result.found ? 'correct' : 'incorrect') },
          ...
          _react2.default.createElement(
            'div',
            { className: 'result-column fixed ' + (result.typeMatched ? 'correct' : 'incorrect') },
            result.typeMatched ? 'True' : 'False'
          ),
          !result.value && _typeof(result.data) !== 'object' && _react2.default.createElement(
            'div',
            { className: 'result-column fixed' },
            result.data
          ),
          result.value && Array.isArray(result.value) && result.value.map(function (item, i) {
            return _react2.default.createElement(
              'div',
              null,
              _react2.default.createElement(
              ...
              _react2.default.createElement(ResultFormatter, { data: item })
            );
          }),
          result.value && !Array.isArray(result.value) && _react2.default.createElement(ResultFormatter, { data: result.value })
        ));
      }
      return _react2.default.createElement(
        'div',
...
var ErrorResult = function (_React$Component4) {
  _inherits(ErrorResult, _React$Component4);

  function ErrorResult() {
    _classCallCheck(this, ErrorResult);

    return _possibleConstructorReturn(this, (ErrorResult.__proto__ || Object.getPrototypeOf(ErrorResult)).apply(this, arguments));
  }

  _createClass(ErrorResult, [{
    key: 'render',
    value: function render() {
      var content = this.props.data && this.props.data.map(function (item) {
        return _react2.default.createElement(
          'div',
          { className: 'error' },
          _react2.default.createElement(
      ...
      return _react2.default.createElement(
        'div',
        { className: 'error-result-container' },
        content
      );
    }
  }]);
...
var reducerCreator = exports.reducerCreator = function reducerCreator(initialState, funcMap) {
  return function () {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
    var params = arguments[1];

    if (params && params.type) {
      var reducerHandler = funcMap[params.type];
...
exports.default = {
  DOUBLE_API: function DOUBLE_API(state, payload) {
    var newState = Object.assign({}, state);
    newState.apiMeta = newState.apiMeta.concat(newState.apiMeta);
    return newState;
  },
  TESTS_RUN: function TESTS_RUN(state, payload) {
    var newState = Object.assign({}, state);
